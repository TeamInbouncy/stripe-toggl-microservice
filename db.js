...
//   // Modified SQL to handle duplicate project IDs gracefully
//   const sql = `
//     INSERT INTO customer_mappings (
//       stripe_customer_id,
//       stripe_subscription_id,
...
//     // Fallback: Try without the conflicting project ID
//     if (err.code === '23505') {
//       console.log('🔄 [DB] Trying fallback insert without project ID constraint...');
//       try {
//         const fallbackSql = `
//           INSERT INTO customer_mappings (
//             stripe_customer_id,
...
//         console.log('✅ [DB] Successfully saved with fallback insert');
//       } catch (fallbackErr) {
//         console.error('❌ [DB] Fallback insert also failed:', fallbackErr);
//       }
//     }
//   }
// }
